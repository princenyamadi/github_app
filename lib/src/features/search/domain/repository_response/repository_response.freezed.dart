...
/// @nodoc
abstract class _$$_RepositoryResponseCopyWith<$Res>
    implements $RepositoryResponseCopyWith<$Res> {
  factory _$$_RepositoryResponseCopyWith(_$_RepositoryResponse value,
          $Res Function(_$_RepositoryResponse) then) =
      __$$_RepositoryResponseCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$_RepositoryResponseCopyWithImpl<$Res>
    extends _$RepositoryResponseCopyWithImpl<$Res, _$_RepositoryResponse>
    implements _$$_RepositoryResponseCopyWith<$Res> {
  __$$_RepositoryResponseCopyWithImpl(
      _$_RepositoryResponse _value, $Res Function(_$_RepositoryResponse) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_RepositoryResponse(
      id: freezed == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_RepositoryResponse implements _RepositoryResponse {
  _$_RepositoryResponse(
      {this.id,
  ...
  factory _$_RepositoryResponse.fromJson(Map<String, dynamic> json) =>
      _$$_RepositoryResponseFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_RepositoryResponse &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_RepositoryResponseCopyWith<_$_RepositoryResponse> get copyWith =>
      __$$_RepositoryResponseCopyWithImpl<_$_RepositoryResponse>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_RepositoryResponseToJson(
      this,
    );
  }
}
...
abstract class _RepositoryResponse implements RepositoryResponse {
  ...
  factory _RepositoryResponse.fromJson(Map<String, dynamic> json) =
      _$_RepositoryResponse.fromJson;
